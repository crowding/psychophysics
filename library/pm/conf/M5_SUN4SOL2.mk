#	make include for Matlab 5 on Solaris 2
#
#       Based on the file M5.SUN4SOL2.mk from the DP toolbox.
#       Modified by E.Svahn for parallel Matlab toolbox, Aug 2000      
#
...
CFLAGS		= -O -DNOUNSETENV -DTIMEOUT=180\
		  ...
		  -I$(M5_ROOT)/extern/include \
		  -I$(PVM_ROOT)/include

LDMEXFLAGS	= -G -M $(M5_ROOT)/extern/lib/sol2/export.map
...
MEXVERSRC 	= $(M5_ROOT)/extern/src/mexversion.c
MEXSUFFIX	= mexsol
