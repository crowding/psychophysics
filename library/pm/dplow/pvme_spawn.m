function [tids,numt] = pvme_spawn(task,ARGV,flag,where,ntask)
%PVME_SPAWN
%	Start new PVM processes.
%	
%	Synopsis:
%		[tids,numt] = pvme_spawn(task,ARGV,flag,where,ntask)
%
%	Input parameters:
...
%              		of  the  PVM  processes  started by this pvme_spawn
%              		call.
%	
...
%      			These error conditions can be returned by pvme_spawn 
...
[numt,tids] = m2pvm(306,task,ARGV,flag,where,ntask);
