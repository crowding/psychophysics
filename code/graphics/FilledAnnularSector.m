...
%----- methods -----
    ...
    function draw(window, next)
        if visible
            ...
            pts = [l(1)+r1*cos(startAngle+arcAngle*(0:nSectors)/nSectors) ...
                   l(1)+r2*cos(startAngle+arcAngle*(nSectors:-1:0)/nSectors);...
                   l(2)-r1*sin(startAngle+arcAngle*(0:nSectors)/nSectors)...
                   l(2)-r2*sin(startAngle+arcAngle*(nSectors:-1:0)/nSectors)];
