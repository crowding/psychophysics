function e = GloloSaccadePrecue(varargin)
    ...
    function b = globalAppearance(b)
        ...
        t = b.cueTime + b.maxLatency - pps.t(1);
        ...
        if (cwOf < ccwOf)
            ...
            trackingProcess.properm ty__(its.n(2), trackingProcess.property__(its.n(1)));
        end
...
%    e.trials.add('targetOnset', @(b)b.targetOnset + b.useTrackingTarget * dx);
    ...
    %begin with an eye calibration and again every couple hiundred trials...
    %
