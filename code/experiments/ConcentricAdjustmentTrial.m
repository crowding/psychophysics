...
%%      how to stop, and return results.
        ...
        function abort(k)
            results = struct('parameter', parameter, 'parameterValue', parameterValues(parameterIndex), 'motion', motion, 'accepted', 0, 'success', 0, 'abort', 1); %#ok
            stop(k, abortSound);
        end
        ...
        function accept(k)
            results = struct('parameter', parameter, 'parameterValue', parameterValues(parameterIndex), 'motion', motion, 'accepted', 1, 'success', 1);
            stop(k, acceptSound);
        end
        
        function reject(k)
            results = struct('parameter', parameter, 'parameterValue', parameterValues(parameterIndex), 'motion', motion, 'accepted', 0, 'success', 1);
            stop(k, rejectSound);
        end
