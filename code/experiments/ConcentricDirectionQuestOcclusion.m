...
%%
    ...
    for i = 1:numel(product)
        product{i}{end+1} = Quest ...
            ...
            , 'guess', 15, 'range', 35, 'grain', 0.1, 'guessSD', 15 ... %conservative initial guess
            , 'criterion', @criterion, 'restriction', PickNearest('set', 7:40, 'dither', 2) ... %experiment constraints
            );
    end
...
%%
    ...
    e.trials.reps = 9; %26 trials per quest...
    e.trials.blockSize = 162;    
