function e = GloLoCued(varargin)
    ...
    e.trials.add({'motion.velocity', 'motion.dphase'}, {{-e.trials.base.motion.velocity, -e.trials.base.motion.dphase}, {e.trials.base.motion.velocity, e.trials.base.motion.dphase}});
