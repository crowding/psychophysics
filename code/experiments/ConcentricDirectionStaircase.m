function this = ConcentricDirectionStaircase(varargin)
    ...
    grid = expandGrid...
        ( values{:}...
          , { @() DiscreteStaircase('criterion', @counterphaseCrowded, 'Nup', 3, 'Ndown', 1, 'valueSet', 1:40, 'currentIndex', 30) ...
          , @() DiscreteStaircase('criterion', @incongruentCrowded, 'Nup', 1, 'Ndown', 1, 'valueSet', 1:30, 'currentIndex', 10) ...
          } ...
        );
