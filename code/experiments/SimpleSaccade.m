function e = SimpleSaccade(varargin)
    ...
    e.trials.add('targetOnset', ExponentialDistribution('offset', 0.4, 'tau', 0.15));
    e.trials.add('targetBlank', ExponentialDistribution('offset', 0.2, 'tau', 0.15));
    e.trials.add('cueTime', ExponentialDistribution('offset', 0.4, 'tau', 0.15));
