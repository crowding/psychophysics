function e = GloLoV(varargin)
    ...
    e.trials = Randomizer('fullFactorial', 1, 'reps', 1, 'blockSize', 68);
    ...
    e.trials.add('patch.velocity', e.trials.base.patch.velocity * linspace(-1.5,1.5,17));
    ...
    e.trials.add('barOnset', e.trials.base.motion.t + e.trials.base.motion.dt * linspace(1,3,17));
