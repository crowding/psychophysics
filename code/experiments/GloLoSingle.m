function e = GloLoFine(varargin)
    ...
    e.trials = Randomizer('fullFactorial', 1, 'reps', 2, 'blockSize', 74);
    ...
    %e.trials.add('motion.dphase', [-1 1] ./ e.trials.base.motion.dphase);
    
    %The range of temporal offsets
    e.trials.add('barOnset', e.trials.base.motion.t + e.trials.base.motion.dt * linspace(-1,1,37));
    ...
    %add some noise to the bar phase to avoid/DIAGNOSE hysteresis
